...
def parse_worker_execution_arguments(arguments):
    ...
    parser.add_argument('--auto-configure-cpu-architecture-explicitly', dest='auto_configure_cpuArch_explicitly', required=False, type=str2bool, default=True, help=CLI_FLAG_AUTO_CPU_ARCH_HELP)

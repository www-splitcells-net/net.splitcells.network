...
def parse_worker_execution_arguments(arguments):
    ...
    parser.add_argument('--execution-name', dest='execution_name', required=True, help="This is the name of the execution, which is executed for a program. Every call needs this argument. It is used to identify i.e. the container, that executes the given commands.")

...
import static net.splitcells.gel.dati.tabula.atribūts.SarakstsAtribūts.listAttribute;
import static net.splitcells.gel.novērtējums.struktūra.RefleksijaNovērtējums.neitrāla;

package net.splitcells.gel.ierobežojums.tips.struktūra;
...
import static net.splitcells.gel.Valoda.ARGUMENTĀCIJA;
import static net.splitcells.gel.dati.datubāze.DatuBāzes.datuBāze;
import static net.splitcells.gel.dati.piešķiršanas.Piešķiršanass.piešķiršanas;
import static net.splitcells.gel.kopīgs.Vārdi.ARGUMENTI;
import static net.splitcells.gel.ierobežojums.vidējs.dati.PiešķiršanaNovērtējums.rindasNovērtējums;
import static net.splitcells.gel.ierobežojums.Ziņojums.report;
import static net.splitcells.gel.ierobežojums.vidējs.dati.GrupuIzdalīšanaVirziens.routingResult;
...
import net.splitcells.gel.ierobežojums.vidējs.dati.PiešķiršanaFiltrs;
import net.splitcells.gel.ierobežojums.vidējs.dati.PiešķiršanaNovērtējums;
import net.splitcells.gel.ierobežojums.Ziņojums;
import net.splitcells.gel.ierobežojums.vidējs.dati.MaršrutēšanaNovērtējums;
import net.splitcells.gel.novērtējums.struktūra.RefleksijaNovērtējumsI;
...
import net.splitcells.gel.ierobežojums.JautājumsI;

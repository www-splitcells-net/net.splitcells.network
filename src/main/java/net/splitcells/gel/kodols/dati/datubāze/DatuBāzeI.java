...
import static net.splitcells.gel.kodols.dati.tabula.kolonna.KolonnaI.kolonna;
import static net.splitcells.gel.kodols.dati.tabula.RindaI.rinda;
import static net.splitcells.gel.kodols.dati.tabula.kolonna.KolonnaSkatsI.kolonnasSkats;
...
public class DatuBāzeI implements DatuBāze {
    ...
    public <T> KolonnaSkats<T> kolonnaSkats(Atribūts<T> atribūts) {
        return kolonnasSkats((Kolonna<T>) kolonnas.get(tips_kolonnasIndekss.get(atribūts)));
    }
    ...
    protected Rinda pieliktTulkošanaNo(List<Object> rindasVertības, int indekss) {
        ...
        ++izmers;
        final var rinda = rinda(this, indekss);
    ...
    public Rinda pieliktUnPārtulkot(List<? extends Object> rindasVertības) {
        ...
        if (indekssiNelitoti.isEmpty()) {
            ...
            rinda = rinda(this, rindasIndekss);

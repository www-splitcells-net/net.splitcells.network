...
public class FileSystemViaClassResourcesFactory extends OptionI<FileSystemViaClassResourcesFactoryApi> {
    public FileSystemViaClassResourcesFactory() {
    ...
    public static FileSystemView fileSystemViaClassResources(Class<?> clazz, String groupId, String artifactId) {
        return configValue(FileSystemViaClassResourcesFactory.class).fileSystemViaClassResources(clazz, groupId, artifactId);
    }
}

...
public class PositionClustersTest {
    ...
    public void testTopRightPositionClusterWithOffset() {
        ...
        testSubject.constraint().childrenView().get(0).lineProcessing()
                ...
                .values()
                .mapped(g -> g.name().orElseThrow())
                .assertEquals(list(FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, -2, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, -2, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(-2, -2, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(-2, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(-2, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, -2, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 1, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(1, 4, -1, -1)
                        , FOR_ALL.value() + " " + groupNameOfPositionCluster(4, 1, -1, -1)));
        rangeClosed(1, 20).forEach(i -> testSubject.deallocate(testSubject.demandsUsed().orderedLine(0)
                , testSubject.suppliesUsed().orderedLine(0)));

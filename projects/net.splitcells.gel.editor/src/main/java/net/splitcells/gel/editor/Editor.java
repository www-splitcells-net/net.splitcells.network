...
import net.splitcells.dem.resource.Lock;
...
import static net.splitcells.dem.resource.Lock.lock;
...
public class Editor implements Discoverable {
    ...
    /**
     * This method is required, as otherwise it cannot be referenced in JavaDoc even though it is generated by Lombok.
     *
     * @return
     */
     ...
     * @param processor
     */
    public <R> R processTablesSynchronously(Function<Editor, R> processor) {

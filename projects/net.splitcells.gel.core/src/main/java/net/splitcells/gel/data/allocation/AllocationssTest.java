...
public class AllocationssTest {
    ...
    public void testHeader() {
        final var attribute1 = AttributeI.attribute(Integer.class, "1");
        final var attribute2 = AttributeI.attribute(Integer.class, "2");
        final var attribute3 = AttributeI.attribute(Integer.class, "3");
        final var attribute4 = AttributeI.attribute(Integer.class, "4");

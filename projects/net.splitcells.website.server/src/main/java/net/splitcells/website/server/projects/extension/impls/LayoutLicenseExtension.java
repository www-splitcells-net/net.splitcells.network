...
public class LayoutLicenseExtension implements ProjectsRendererExtension {
    public static LayoutLicenseExtension layoutLicenseExtension() {
        return new LayoutLicenseExtension();
    }

    private static final String PATH = "/net/splitcells/website/layout-license.html";

    private LayoutLicenseExtension() {

...
public class CommonMarkChangelogEventRenderer implements Renderer {

    public static CommonMarkChangelogEventRenderer commonMarkChangelogEventRenderer() {
        return new CommonMarkChangelogEventRenderer();
    }

    private final CommonMarkIntegration renderer = commonMarkIntegration();

    private CommonMarkChangelogEventRenderer() {
    }

...
public class CommonMarkDevelopmentProjectRendererExtensionTest {
    /**
    ...
    public void testDevelopmentLayout() {
        final var testSubject = projectRenderer
                ("public"
                        ...
                        , a -> Optional.empty()
                        , Config.create());
        assertThat(testSubject.projectPaths()).contains(Path.of("net/splitcells/network/DEVELOPMENT.html"));
    }
}

...
public class NoCode2SolutionCalculator implements Processor<Tree, Tree> {
    ...
    public static NoCode2SolutionCalculator noCode2SolutionCalculator() {
        return new NoCode2SolutionCalculator();
    }

    private NoCode2SolutionCalculator() {

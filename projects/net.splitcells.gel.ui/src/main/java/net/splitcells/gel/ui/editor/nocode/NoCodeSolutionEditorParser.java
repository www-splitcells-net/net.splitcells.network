...
public class NoCodeSolutionEditorParser implements Function<Request<Tree>, Result<SolutionEditor, Tree>> {
    public static final String PROBLEM_DEFINITION = "net-splitcells-gel-ui-editor-nocode-form-problem-definition";

    public static NoCodeSolutionEditorParser noCodeSolutionEditorParser() {
        return new NoCodeSolutionEditorParser();
    }

    private NoCodeSolutionEditorParser() {
    ...
    public Result<SolutionEditor, Tree> apply(Request<Tree> request) {
        ...
        final String editorCode = problemDefinition
                .get(0)
                .child(0)
                .name();

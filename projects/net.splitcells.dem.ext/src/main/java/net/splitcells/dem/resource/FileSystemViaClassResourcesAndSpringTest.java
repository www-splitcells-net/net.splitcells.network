...
public class FileSystemViaClassResourcesAndSpringTest extends FileSystemViaClassResourcesTest {
    @Tag(INTEGRATION_TEST)
    @TestFactory
    @Override
    public Stream<DynamicTest> testStdFactory() {
        return testFactory(fileSystemViaClassResourcesAndSpringFactory());
    }
}

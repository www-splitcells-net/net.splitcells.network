...
public class FileSystemViaClassResourcesAndSpringFactory implements FileSystemViaClassResourcesFactoryApi {
    ...
    public static FileSystemViaClassResourcesFactoryApi fileSystemViaClassResourcesAndSpringFactory() {
        return new FileSystemViaClassResourcesAndSpringFactory();
    }

    private FileSystemViaClassResourcesAndSpringFactory() {

    }

    @Override
    public FileSystemView fileSystemViaClassResources(Class<?> clazz, String groupId, String artifactId) {
        return FileSystemViaClassResourcesAndSpring.fileSystemViaClassResourcesAndSpring(clazz, groupId, artifactId);
    }
}

...
<xsl:stylesheet version="2.0" xmlns:s="http://splitcells.net/sew.xsd"
    ...
    <xsl:template match="s:layout.config">
        ...
        <html>
            ...
            <body>
                <main class="Standard_highlighted">
                    <div id="topElement" class="topElement beginningOfContent background_not_important topLightShadow">
                        <div class="mainElement Layout mainElement_Container">
